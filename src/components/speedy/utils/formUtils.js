...
import { renderText, renderSelect, renderRadioGroup, renderCheckboxGroup, renderInputNumber, renderCascader, renderSwitch, renderSlider, renderTime, renderTimerange, renderDate, renderDaterange, renderDatetime, renderDatetimerange, renderRate } from '../SpeedyForm/renders';
...
export const renderSpecifyItem = (item, form, eventStore, store) => {
